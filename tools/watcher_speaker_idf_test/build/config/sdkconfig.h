...
#define CONFIG_BSP_AUDIO_MIC_VALUE_GAIN 0
#define CONFIG_BSP_LCD_DEFAULT_BRIGHTNESS 100
#define CONFIG_BSP_LCD_PANEL_SPI_TRANS_Q_DEPTH 2
#define CONFIG_BSP_LCD_SPI_DMA_SIZE_DIV 1
#define CONFIG_LVGL_DRAW_BUFF_HEIGHT 412
#define CONFIG_LVGL_PORT_TASK_STACK_SIZE 10240
#define CONFIG_LVGL_PORT_TASK_PRIORITY 4
#define CONFIG_LVGL_PORT_TASK_AFFINITY_NO_AFFINTY 1
#define CONFIG_LVGL_PORT_TASK_AFFINITY -1
#define CONFIG_LVGL_INPUT_DEVICE_USE_KNOB 1
#define CONFIG_LVGL_INPUT_DEVICE_USE_TP 1
#define CONFIG_LVGL_INPUT_DEVICE_SENSITIVITY -1
#define CONFIG_LVGL_PORT_TASK_MAX_SLEEP_MS 500
#define CONFIG_LVGL_PORT_TIMER_PERIOD_MS 5
#define CONFIG_SSCMA_EVENT_QUEUE_SIZE 2
#define CONFIG_SSCMA_TX_BUFFER_SIZE 8192
#define CONFIG_SSCMA_RX_BUFFER_SIZE 98304
#define CONFIG_SSCMA_PROCESS_TASK_STACK_SIZE 4096
#define CONFIG_SSCMA_PROCESS_TASK_PRIORITY 5
#define CONFIG_SSCMA_PROCESS_TASK_AFFINITY_NO_AFFINTY 1
#define CONFIG_SSCMA_PROCESS_TASK_AFFINITY -1
#define CONFIG_SSCMA_MONITOR_TASK_STACK_SIZE 4096
#define CONFIG_SSCMA_MONITOR_TASK_PRIORITY 4
#define CONFIG_SSCMA_MONITOR_TASK_AFFINITY_NO_AFFINTY 1
