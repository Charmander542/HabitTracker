...
/* SenseCAP Watcher BSP uses legacy i2c_driver_install() on BSP_GENERAL_I2C_NUM.
 * esp_codec_dev switches to i2c_master.h on IDF >= 5.3, which requires bus_handle
 * and must not share the same port with the legacy driver. Force legacy I2C here. */
